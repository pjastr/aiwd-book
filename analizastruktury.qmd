...
* wyznaczenie dominanty ma sens kiedy rozkład jest jednomodalny (jednostki mają jeden punkt skupienia), w przypadku rozkładów wielomodalnych dominanta traci użyteczność jako miara przeciętna.
...
* przynajmniej połowa jednostek ma wartość cechy mniejszą lub równą medianie.
